...
// ---
import 'package:stripe_edge_function/blocs/sign_in/event.dart';
...
import 'package:stripe_edge_function/pages/unauthenticated/sign_in/widgets/connector/email_text_field.dart';
import 'package:stripe_edge_function/pages/unauthenticated/sign_in/widgets/connector/password_text_field.dart';
import 'package:stripe_edge_function/pages/unauthenticated/sign_in/widgets/connector/sign_in_button.dart';
import 'package:stripe_edge_function/shared/widgets/dumb/button.dart';
        ...
        await tester.screenshot(
          ...
          arrangeBeforeActions: (arrange) {
            when(
              ...
              // ATTENTION 2/7
              when(() => arrange.mocks.paymentsRepository.getAccountId())
