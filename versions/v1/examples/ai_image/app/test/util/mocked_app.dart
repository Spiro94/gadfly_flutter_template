import 'package:ai_image/effects/auth_change/provider.dart';
import 'package:ai_image/effects/now/provider.dart';
import 'package:ai_image/repositories/auth/repository.dart';
// ATTENTIO 1/3
import 'package:ai_image/repositories/image_generation/repository.dart';
// ---
...
class MocksContainer {
  ...
  // ATTENTION 2/3
  final imageGenerationRepository = MockImageGenerationRepository();
  // ---
}
