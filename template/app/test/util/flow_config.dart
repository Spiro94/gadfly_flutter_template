...
FTConfig<MocksContainer> createFlowConfig({
  ...
  onListItemRegexes: [
    FTOnRegexMatch(regex: RegExp('ANALYTIC'), onMatch: (match) => 'analytic'),
    FTOnRegexMatch(regex: RegExp('INFO'), onMatch: (match) => 'info'),
    FTOnRegexMatch(regex: RegExp('WARNING'), onMatch: (match) => 'warning'),
    FTOnRegexMatch(regex: RegExp('SEVERE'), onMatch: (match) => 'severe'),
    FTOnRegexMatch(regex: RegExp('SHOUT'), onMatch: (match) => 'shout'),
  ],
);
