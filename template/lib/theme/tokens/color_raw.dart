...
final _colorRawTokens = ThemeColorRawTokens(
  primary: ThemeColorRawVariations(
  ...
  secondary: ThemeColorRawVariations(
  ...
  success: ThemeColorRawVariations(
  ...
  warning: ThemeColorRawVariations(
  ...
  neutral: ThemeColorRawVariations(
  ...
  neutralVariant: ThemeColorRawVariations(
...
/// The complete set of [ThemeColorRawVariations].
class ThemeColorRawTokens extends ThemeExtension<ThemeColorRawTokens>
    with EquatableMixin {
  const ThemeColorRawTokens({
  ...
  final ThemeColorRawVariations primary;

  /// This color set is the secondary accent
  final ThemeColorRawVariations secondary;

  /// This color set is used to indicate a success
  final ThemeColorRawVariations success;

  /// This color set is used to indicate an error
  final ThemeColorRawVariations error;

  /// This color set is used to indicate information
  final ThemeColorRawVariations info;

  /// This color set is used to warnings
  final ThemeColorRawVariations warning;

  /// This color set is used for texture and is considered to have neutral
  /// semantic meaning
  final ThemeColorRawVariations neutral;

  /// This color set is used for texture and is considered to have neutral
  /// semantic meaning
  final ThemeColorRawVariations neutralVariant;

  @override
  ThemeExtension<ThemeColorRawTokens> copyWith({
    ThemeColorRawVariations? primary,
    ThemeColorRawVariations? secondary,
    ThemeColorRawVariations? success,
    ThemeColorRawVariations? error,
    ThemeColorRawVariations? info,
    ThemeColorRawVariations? warning,
    ThemeColorRawVariations? neutral,
    ThemeColorRawVariations? neutralVariant,
  }) {
    return ThemeColorRawTokens(
  ...
  /// Linear interpolation of [ThemeColorRawTokens]
  @override
  ThemeColorRawTokens lerp(ThemeColorRawTokens? other, double t) {
    if (other is! ThemeColorRawTokens) return this;
    return ThemeColorRawTokens(
...
class ThemeColorRawVariations extends Equatable {
  const ThemeColorRawVariations({
    required this.none,
  ...
  /// linear interpolation of [ThemeColorRawVariations]
  ThemeColorRawVariations lerp(ThemeColorRawVariations? other, double t) {
    if (other is! ThemeColorRawVariations) return this;
    return ThemeColorRawVariations(
