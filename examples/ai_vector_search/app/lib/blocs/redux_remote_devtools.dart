...
void remoteReduxDevtoolsOnCreate({
  ...
  if (remoteReduxDevtoolsStore != null) {
    switch (bloc) {
      ...
      // ATTENTION 6/8
      case SearchBaseBloc():
        devtoolsDb = devtoolsDb.copyWith(searchState: bloc.state);
      // ---
    }
...
void remoteReduxDevtoolsOnTransition({
  ...
  if (remoteReduxDevtoolsStore != null) {
    switch (bloc) {
      ...
      // ATTENTION 7/8
      case SearchBaseBloc():
        devtoolsDb = devtoolsDb.copyWith(searchState: state as SearchState);
      // ---
    }
...
void remoteReduxDevtoolsOnClose({
  ...
  if (remoteReduxDevtoolsStore != null) {
    switch (bloc) {
      ...
      // ATTENTION 8/8
      case SearchBaseBloc():
        devtoolsDb = devtoolsDb.copyWith(clearSearchState: true);
      // ---
    }
