...
class DevtoolsDb {
  ...
  DevtoolsDb copyWith({
    ...
    return DevtoolsDb(
      ...
      // ATTENTION 5/8
      chatState: clearChatState ? null : chatState ?? this.chatState,
      // ---
...
void remoteReduxDevtoolsOnCreate({
  ...
  if (remoteReduxDevtoolsStore != null) {
    switch (bloc) {
      ...
      // ATTENTION 6/8
      case ChatBaseBloc():
        devtoolsDb = devtoolsDb.copyWith(chatState: bloc.state);
      // ---
...
void remoteReduxDevtoolsOnTransition({
  ...
  if (remoteReduxDevtoolsStore != null) {
    switch (bloc) {
      ...
      // ATTENTION 7/8
      case ChatBaseBloc():
        devtoolsDb = devtoolsDb.copyWith(chatState: state as ChatState);
      // ---
...
void remoteReduxDevtoolsOnClose({
  ...
  if (remoteReduxDevtoolsStore != null) {
    switch (bloc) {
      ...
      // ATTENTION 8/8
      case ChatBaseBloc():
        devtoolsDb = devtoolsDb.copyWith(clearChatState: true);
      // ---
