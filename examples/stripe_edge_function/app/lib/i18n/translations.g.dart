...
/// Strings: 30
///
/// Built on 2023-10-09 at 23:32 UTC
...
class TranslationsHomeEn {
	...
	String get createStripeAccount => 'Create Stripe Account';
	String stripeId({required Object stripeId}) => 'Stripe ID: ${stripeId}';
}
...
extension on TranslationsEn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'home.createStripeAccount': return 'Create Stripe Account';
			case 'home.stripeId': return ({required Object stripeId}) => 'Stripe ID: ${stripeId}';
