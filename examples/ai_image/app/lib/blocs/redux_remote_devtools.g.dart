...
DevtoolsDb _$DevtoolsDbFromJson(Map<String, dynamic> json) => DevtoolsDb(
      ...
      imageGenerationState: json['imageGenerationState'] == null
          ? null
          : ImageGenerationState.fromJson(
              json['imageGenerationState'] as Map<String, dynamic>),
    );
...
Map<String, dynamic> _$DevtoolsDbToJson(DevtoolsDb instance) =>
    <String, dynamic>{
      ...
      'imageGenerationState': instance.imageGenerationState,
    };
