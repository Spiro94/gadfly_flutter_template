...
DevtoolsDb _$DevtoolsDbFromJson(Map<String, dynamic> json) => DevtoolsDb(
      ...
      customClaimsState: json['customClaimsState'] == null
          ? null
          : CustomClaimsState.fromJson(
              json['customClaimsState'] as Map<String, dynamic>),
    );
...
Map<String, dynamic> _$DevtoolsDbToJson(DevtoolsDb instance) =>
    <String, dynamic>{
      ...
      'customClaimsState': instance.customClaimsState,
    };
