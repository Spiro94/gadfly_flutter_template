...
// ATTENTION 1/2
import 'custom_claims/event.dart';
...
// ATTENTION 2/2
class CustomClaimsBaseBloc
    extends AppBaseBloc<CustomClaimsEvent, CustomClaimsState> {
  CustomClaimsBaseBloc(super.initialState);
}
// ---
