...
// ATTENTION 1/8
import 'custom_claims/state.dart';
// ---
...
class DevtoolsDb {
  ...
  // ATTENTION 3/8
  final CustomClaimsState? customClaimsState;
  // ---
  ...
  DevtoolsDb copyWith({
    ...
    // ATTENTION 4/8
    CustomClaimsState? customClaimsState,
    bool clearCustomClaimsState = false,
    // ---
  }) {
    return DevtoolsDb(
      ...
      // ATTENTION 5/8
      customClaimsState: clearCustomClaimsState
          ? null
          : customClaimsState ?? this.customClaimsState,
      // ---
    );
  }
...
void remoteReduxDevtoolsOnCreate({
  ...
  if (remoteReduxDevtoolsStore != null) {
    switch (bloc) {
      ...
      // ATTENTION 6/8
      case CustomClaimsBaseBloc():
        devtoolsDb = devtoolsDb.copyWith(customClaimsState: bloc.state);
      // ---
    }
...
void remoteReduxDevtoolsOnTransition({
  ...
  if (remoteReduxDevtoolsStore != null) {
    switch (bloc) {
      ...
      case CustomClaimsBaseBloc():
        devtoolsDb =
            devtoolsDb.copyWith(customClaimsState: state as CustomClaimsState);
      // ---
    }
...
void remoteReduxDevtoolsOnClose({
  ...
  if (remoteReduxDevtoolsStore != null) {
    switch (bloc) {
      ...
      // ATTENTION 8/8
      case CustomClaimsBaseBloc():
        devtoolsDb = devtoolsDb.copyWith(clearCustomClaimsState: true);
      // ---
    }
